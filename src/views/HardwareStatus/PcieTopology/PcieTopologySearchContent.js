...
export const pcieTopologySearchContent = {
  ...
  keywords: [
    ...
    'check PCIe topology',
    'monitor PCIe topology',
    'PCIe structure',
    'PCIe hierarchy',
    'hardware structure',
    'hardware hierarchy',
    'how to view PCIe topology',
    'how to filter PCIe topology',
    'how to reset PCIe link',
    'how to identify PCIe device',
    'where is PCIe topology',
    'where are PCIe slots',
    'find PCIe topology',
    'find PCIe devices',
    'show PCIe devices',
    'view PCIe devices',
    'display PCIe devices',
    'list PCIe devices',
    'show PCIe slots',
    'view PCIe slots',
    'display PCIe slots',
