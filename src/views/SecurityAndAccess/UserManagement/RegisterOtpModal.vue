  ...
  >
    <b-row>
      <b-col>
        <b-row>
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/d/dd/Qr-code-ver-40.svg"
            alt="QR Code"
            style="max-width: 350px"
          />
        </b-row>
        <b-row>
          <b-col> Secret key: sfghdkhjdshjzgueygweyfvwhjwqdh </b-col
          ><icon-copy />
        </b-row>
      </b-col>
      <b-col>
