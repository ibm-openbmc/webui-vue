...
export const serviceLoginConsolesSearchContent = {
  ...
  keywords: [
    ...
    'how to access service console',
    'how to open service console',
    'how to use service console',
    'where is service console',
    'show service console',
    'view service console',
    'display service console',
    'open service console',
    'access BMC console',
    'open BMC console',
    'use BMC console',
    'access hypervisor console',
    'open hypervisor console',
    'use hypervisor console',
    'show BMC console',
    'view BMC console',
    'show hypervisor console',
    'view hypervisor console',
    'select BMC console',
    'select hypervisor console',
    'choose console',
    'pick console',
    'switch console',
    'change console',
