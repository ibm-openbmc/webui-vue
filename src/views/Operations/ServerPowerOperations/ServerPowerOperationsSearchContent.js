...
export const serverPowerOperationsSearchContent = {
  ...
  keywords: [
    ...
    'show power operations',
    'view power operations',
    'display power operations',
    'see power operations',
    'server power control',
    'power management',
    'manage server power',
    'control server power',
    'how to power on server',
    'how to power off server',
    'how to shutdown server',
    'how to reboot server',
    'how to restart server',
    'where is power operations',
    'find power operations',
    'turn on server',
    'turn off server',
    'start server',
    'stop server',
