...
export const ibmiServiceFunctionsSearchContent = {
  ...
  keywords: [
    ...
    'show IBM i service functions',
    'view IBM i service functions',
    'display IBM i service functions',
    'access IBM i service functions',
    'where is IBM i service functions',
    'how to execute service functions',
    'how to run service functions',
