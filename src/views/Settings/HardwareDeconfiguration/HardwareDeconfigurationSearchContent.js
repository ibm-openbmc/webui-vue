...
export const hardwareDeconfigurationSearchContent = {
  ...
  keywords: [
    ...
    'show hardware deconfiguration',
    'view hardware deconfiguration',
    'display hardware deconfiguration',
    'configure hardware deconfiguration',
    'where is hardware deconfiguration',
    'show memory DIMMs',
    'view memory DIMMs',
    'display memory DIMMs',
    'show processor cores',
    'view processor cores',
    'display processor cores',
    'show deconfigured hardware',
    'view deconfigured hardware',
    'list deconfigured components',
    'show disabled hardware',
    'view disabled hardware',
    'how to filter deconfiguration',
    'how to view deconfigured memory',
    'how to view deconfigured cores',
    'filter by deconfiguration type',
    'filter memory DIMMs',
    'filter processor cores',
    'show functional state',
    'view functional state',
