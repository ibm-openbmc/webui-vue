...
export const powerRestorePolicySearchContent = {
  ...
  keywords: [
    ...
    'show power restore policy',
    'view power restore policy',
    'display power restore policy',
    'configure power restore',
    'set power restore',
    'power restore settings',
    'how to configure power restore',
    'how to set power policy',
    'where is power restore',
    'find power restore',
    'power after outage',
    'power after loss',
    'auto restart',
