const useTableFilterComposable = () => {
  ...
  const getFilteredTableDataByDate = (tableData = [], startDate, endDate, propertyKey = 'date') => {
    ...
    const isUtcDisplay = this.$store.getters['global/isUtcDisplay']; // replcae by importing store data
...
export default useTableFilterComposable;
